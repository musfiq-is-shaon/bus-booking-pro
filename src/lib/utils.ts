...
export function generateTicketHTML(ticket: TicketData): string {
  return `
    ...
    <html>
    <head>
      <title>BusBooking Pro - Ticket ${ticket.bookingReference}</title>
      <style>
    ...
    <body>
      <div class="ticket">
        ...
        <div class="footer">
          ...
          <p>Generated by BusBooking Pro - Bangladesh's Trusted Bus Booking Platform</p>
        </div>
      </div>
